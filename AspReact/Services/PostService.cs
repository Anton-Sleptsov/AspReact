...
namespace AspReact.Services
{
    public class PostService : IPostService
    {
        ...
        {
            PostModel lastPost = _dataContext.Posts.LastOrDefault();
        ...
        {
            PostModel modelToUpdate = _dataContext.Posts.FirstOrDefault(x => x.Id == model.Id);
        ...
        {
            PostModel modelToDelete = _dataContext.Posts.FirstOrDefault(x => x.Id == id);
